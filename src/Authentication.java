...
public class start {
		...
		while((credential = bufferedReaderObject.readLine())!=null){
			...
			if(credentials!=null) {
				if(credentials[0]!=""||credentials[1]!="") {
					if (credentials[0].toLowerCase() == username.toLowerCase() && credentials[1] == password) {
	...
	public static void main(String[] args) throws IOException {
		...
		System.out.println("operations available 1. registration 2. authentication 3.DB Dump Creation 4. ERD Generation");
